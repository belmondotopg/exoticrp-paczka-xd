...
Config.Permissions = { --Define which players can access the cd_easytime features.
    Framework = { --Ignore this section if you're not using a framework.
        ['esx'] = {'founder', 'developer', 'managment'},
        ['qbcore'] = {'god', 'admin', },
        ['qbox'] = {'god', 'admin', },
    },
...
Config.Command = 'weather' --The command for staff to open the UI.
...
Config.TsunamiWarning = {
    ENABLE = false, --Do you want to enable the tsunami warning countdown just before a server restart?
...
Config.Weather = {
    ...
    GameWeather = { --If you chose 'game', you have the following configurable options:
        dynamic_weather_time = 30, --How often (in minutes) should the weather change?
        ...
        fog_chance = 10, --Chance of fog (0-100%) if the fog WeatherGroup is randomly selected.
...
Config.Time = {
    ...
    GameTime = { --If you chose 'game', you have the following configurable options:
        time_cycle_speed = 3 --How long a full day/night cycle lasts. 1 = 24 mins, 2 = 48 mins, 3 = 72 mins, etc. 2 is the default same as GTA.
    },
