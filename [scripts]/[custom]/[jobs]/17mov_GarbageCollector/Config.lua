...
Config.Lang = "pl"                                  -- Here you can set language from locales directory
...
Config.AutoSearchForConflicts = false
Config.VersionCheck = {
...
Config.Price = 540                                    -- Price per one bag inside trashmaster. 100 is maximum so full trash = 200$ / partyCount (increased by 35%)
...
Config.EnableExploitFix = true                      -- Set to true to enable checking if any players is withing x meters while bag is being picked.
Config.ExploitFixDistance = 3.0                     -- Distance in meters for exploit fix
...
Config.ProgressBarOffset = "255px"                   -- Value in px of counter offset on screen
