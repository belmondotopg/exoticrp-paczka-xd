...
ESX.RegisterCommand("duty", "user", function(xPlayer, args, showError)
    -- Otwórz menu zarządzania pracą (tak samo jak F1 > Postać > Zarządzanie Pracą)
    TriggerClientEvent("esx_multijob:openJobMenu", xPlayer.source)
end, false, {
    help = "Otwórz menu zarządzania pracą (tak samo jak F1 > Postać > Zarządzanie Pracą)"
})