...
Config.MaxNotifications = 30 -- the maximum amount of notifications a player can have. if they have more than this, the oldest notifications will be deleted. set to false to disable
...
Config.Companies.Services = {
    ...
    },
    {
        ...
        canCall = true,                      -- if true, players can call the company
        canMessage = true,                   -- if true, players can message the company
        bossRanks = { "sedzia", "sedziaf" }, -- ranks that can manage the company
        location = {
            name = "Ratusz",
            coords = {
                x = -336.6,
...
Config.EmailDomain = "exoticrp.pl"
...
Config.GroupMessageMemberLimit = true -- maximum amount of members in a group message
...
Config.KeyBinds = {
    ...
    Open = {
        Command = "phone",
        Bind = "",
        Description = "Otwórz telefon"
    },
    Focus = {
        Command = "togglePhoneFocus",
        Bind = "LMENU",
        Description = "Włącz/wyłącz kursor w telefonie"
    },
    StopSounds = {
        Command = "stopSounds",
        Bind = false,
        Description = "Zatrzymaj wszystkie dźwięki telefonu"
    },

    FlipCamera = {
        Command = "flipCam",
        Bind = "UP",
        Description = "Obróć kamerę telefonu"
    },
    TakePhoto = {
        Command = "takePhoto",
        Bind = "RETURN",
        Description = "Zrób zdjęcie / nagraj wideo"
    },
    ToggleFlash = {
        Command = "toggleCameraFlash",
        Bind = "E",
        Description = "Włącz/wyłącz lampę błyskową"
    },
    LeftMode = {
        Command = "leftMode",
        Bind = "LEFT",
        Description = "Zmień tryb"
    },
    RightMode = {
        Command = "rightMode",
        Bind = "RIGHT",
    ...
    RollLeft = {
        ...
        Bind = "Z",
        Description = "Przechyl kamerę w lewo"
    },
    RollRight = {
        Command = "cameraRollRight",
        Bind = "C",
        Description = "Przechyl kamerę w prawo"
    },
    FreezeCamera = {
        Command = "cameraFreeze",
        Bind = "X",
        Description = "Zamroź kamerę"
    },

    AnswerCall = {
        Command = "answerCall",
        Bind = "RETURN",
        Description = "Odbierz przychodzące połączenie"
    },
    DeclineCall = {
        Command = "declineCall",
        Bind = "BACK",
        Description = "Odrzuć przychodzące połączenie"
    },
    UnlockPhone = {
        Bind = "SPACE",
        Description = "Odblokuj telefon",
    },
}
