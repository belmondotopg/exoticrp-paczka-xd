...
---@alias CheckEvent "openPhone" | "createDarkChatChannel" | "joinDarkChatChannel" | "startInstaPicLive" | "joinInstaPicLive" | "postInstaPicStory" | "buyCrypto" | "sellCrypto" | "transferCrypto"
