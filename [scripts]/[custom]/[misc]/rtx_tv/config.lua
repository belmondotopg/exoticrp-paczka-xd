...
Config.Language = "Polish" -- text language from code, if you want translate interface, you need do it manually in html folder.
...
Config.VehicleTelevisionBlacklist = true -- if you enable this, television will work not for vehicles which is in blacklisted config, you need put vehicles in Config.TelevisonBlacklistedVehicles. 
...
Config.StreamerModeCommand = "streamertv" -- command for disable music for example for streamers, when player will use this command he will not hear music from televisions
...
Config.TelevisionControlSettings = {
	acepermissionsforusecontrolmenu = {enable = true, permission = "rtxtv.managment"}, -- enable this if you want to use ace permissions
