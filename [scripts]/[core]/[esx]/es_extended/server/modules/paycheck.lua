    ...
    CreateThread(function()
        while true do
            ...
            for player, xPlayer in pairs(ESX.Players) do
                ...
                local salary = (jobName == "unemployed" or onDuty) and xPlayer.job.grade_salary or ESX.Math.Round(xPlayer.job.grade_salary * Config.OffDutyPaycheckMultiplier)
                                ...
                                if society ~= nil then -- verified society
                                    TriggerEvent("esx_addonaccount:getSharedAccount", society.account, function(account)
                                        if account.money >= salary then -- does the society money to pay its employees?
                                            ...
                                            TriggerClientEvent("esx:showNotification", player, TranslateCap("company_nomoney"), "error")
                                        end
                                    end)
                                else -- not a society
                                    xPlayer.addAccountMoney("bank", salary, "Paycheck")
