...
function CreateExtendedPlayer(playerId, identifier, group, accounts, inventory, weight, job, loadout, name, coords, metadata, badge, discordid, playerName, nationality, multi_jobs)
    ---@class xPlayer
    local self = {}
    ...
    self.vip = ESX.AddonPlayerDiscordRoles(playerId, 'VIP')
    self.svip = ESX.AddonPlayerDiscordRoles(playerId, 'SVIP')
    self.elite = ESX.AddonPlayerDiscordRoles(playerId, 'ELITE')
    self.pedperms = ESX.AddonPlayerDiscordRoles(playerId, 'PED')
    ...
    stateBag:set("playerName", self.playerName, true)
    stateBag:set('playerIndex', ESX.GetRandomString(math.random(5, 20))..'-'..math.random(10000,99999), true)
    stateBag:set('vip', self.vip, true)
    stateBag:set('svip', self.svip, true)
    stateBag:set('elite', self.elite, true)
    stateBag:set('pedperms', self.pedperms, true)
    ...
    function self.setName(newName)
        ...
        Player(self.source).state:set("name", self.playerName, true)
    end
