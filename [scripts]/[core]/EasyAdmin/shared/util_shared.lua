permissions = {
	...
	["vehicle.fix.engine"] = false,
	["vehicle.fix.body"] = false,
	["vehicle.fix.all"] = false,
	["vehicle.givekeys"] = false,

	["dev.showcordinates"] = false,
	["dev.copycordinates"] = false,

	["general.noclip"] = false,
	["general.invisible"] = false,
	["general.revive"] = false,
	["general.tpm"] = false,
}
...
function loadLanguageStrings()
	local strfile = LoadResourceFile(GetCurrentResourceName(), "language/" .. GetConvar("ea_LanguageName", "en") ..
		".json")
	if strfile then
